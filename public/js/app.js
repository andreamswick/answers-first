...
},{"core-js/library/fn/symbol":3}],2:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/core-js/symbol":1}],3:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
module.exports = require('../../modules/$.core').Symbol;
},{"../../modules/$.core":7,"../../modules/es6.object.to-string":31,"../../modules/es6.symbol":32}],4:[function(require,module,exports){
...
},{"./$.is-object":20}],6:[function(require,module,exports){
...
},{"./$.fails":13}],11:[function(require,module,exports){
...
},{"./$.core":7,"./$.ctx":8,"./$.global":15}],13:[function(require,module,exports){
...
},{"./$":21,"./$.to-iobject":28}],15:[function(require,module,exports){
...
},{"./$":21,"./$.descriptors":10,"./$.property-desc":24}],18:[function(require,module,exports){
// fallback for non-array-like ES3 and non-enumerable old V8 strings
var cof = require('./$.cof');
module.exports = Object('z').propertyIsEnumerable(0) ? Object : function(it){
  return cof(it) == 'String' ? it.split('') : Object(it);
};
},{"./$.cof":6}],19:[function(require,module,exports){
...
},{"./$":21,"./$.to-iobject":28}],23:[function(require,module,exports){
module.exports = true;
...
},{"./$.hide":17}],26:[function(require,module,exports){
...
},{"./$":21,"./$.has":16,"./$.wks":30}],27:[function(require,module,exports){
var global = require('./$.global')
...
},{"./$.defined":9,"./$.iobject":18}],29:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./$.global":15,"./$.shared":27,"./$.uid":29}],31:[function(require,module,exports){
...
},{"./$":21,"./$.an-object":5,"./$.descriptors":10,"./$.enum-keys":11,"./$.export":12,"./$.fails":13,"./$.get-names":14,"./$.global":15,"./$.has":16,"./$.is-array":19,"./$.keyof":22,"./$.library":23,"./$.property-desc":24,"./$.redefine":25,"./$.set-to-string-tag":26,"./$.shared":27,"./$.to-iobject":28,"./$.uid":29,"./$.wks":30}],33:[function(require,module,exports){
/*!
...
new Vue({
    el: '#app-layout',
    components: { Modal: Modal, Game: Game, PlayGame: PlayGame },
    data: {},
    methods: {}
});

},{"./components/Game.vue":42,"./components/PlayGame.vue":43,"bootstrap-sass":33,"jquery":34,"vue":40,"vue-resource":37,"vue-router":38,"vue-strap/dist/vue-strap.min":39}],42:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        showQuestion: function showQuestion(section, amount) {
            this.section = section;
            this.amount = amount;
            if (this.questions[this.section][this.amount]['question'] !== (typeof undefined === 'undefined' ? 'undefined' : (0, _typeof3.default)(undefined))) {
...
exports.default = {
    ...
    methods: {
        showQuestion: function showQuestion(section, amount) {
            this.section = section;
            this.amount = amount;
            if (this.game.questions[this.section][this.amount]['question'] !== (typeof undefined === 'undefined' ? 'undefined' : (0, _typeof3.default)(undefined))) {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <h1 class=\"text-center\">{{ game.name }}</h1>\n    <table class=\"table table-bordered\">\n        <thead>\n        <tr>\n            <th class=\"text-center\" v-for=\"section in game.questions\">\n                <h4>{{ section.title }}</h4>\n            </th>\n        </tr>\n        </thead>\n        <tbody>\n\n        <tr v-for=\"amount in amounts\">\n            <td v-for=\"n in sections\">\n                <button type=\"button\" class=\"btn btn-primary btn-block {{ questions[n][amount] === true ? 'btn-fill' : '' }}\" @click=\"showQuestion(n, amount)\">${{ amount }}\n                </button>\n            </td>\n        </tr>\n        </tbody>\n    </table>\n\n    <div class=\"modal fade\" id=\"questionModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"questionModalLabel\">\n        <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n                <div class=\"modal-header\">\n                    <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">×</span></button>\n                    <h4 class=\"modal-title\">Section {{ section+1 }}: ${{ amount }} Question</h4>\n                </div>\n                <div class=\"modal-body\">\n                    <h3 class=\"text-center page-header\">{{ answer }}</h3>\n\n                    <p class=\"text-center\" v-show=\"isQuestionShown\">{{ question }}</p>\n                    <p class=\"text-center\"><button type=\"button\" class=\"btn btn-default\" @click=\"isQuestionShown = true\" v-show=\"!isQuestionShown\">Show Question\n                    </button></p>\n                </div>\n                <div class=\"modal-footer\">\n                    <button type=\"button\" class=\"btn btn-primary\" @click=\"saveQuestion\">Close</button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-493d06ac", module.exports)
  } else {
    hotAPI.update("_v-493d06ac", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/helpers/typeof":2,"vue":40,"vue-hot-reload-api":36}]},{},[41]);
